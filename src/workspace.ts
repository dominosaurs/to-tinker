...
export function resolveLaravelWorkspace(document: vscode.TextDocument): LaravelWorkspace {
  ...
  throw new Error(`No Laravel artisan file found from ${documentPath} up to workspace root ${folderPath}.`);
}
